...
GOLD_LABEL_SPECS: tuple[GoldLabelSpec, ...] = (
    ...
    GoldLabelSpec("nvda-data-center-demand", "NVDA data center demand", "NVDA", ("data center",), max_labels=1),
    ...
    GoldLabelSpec("amd-data-center", "AMD data center", "AMD", ("data center", "revenue"), max_labels=1),
    ...
    GoldLabelSpec("msft-azure-revenue", "MSFT Azure revenue", "MSFT", ("azure", "revenue"), max_labels=1),
    ...
    GoldLabelSpec("xom-capital-spending", "XOM capital spending", "XOM", ("capital", "spending"), max_labels=1),
